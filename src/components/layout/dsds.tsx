...
export function Header() {
  ...
  const navItems = [
    ...
    { name: "Tours", href: "#tours", active: false },
  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50 pt-[49px]">
              ...
              <div className="flex items-center space-x-4">
                {navItems.slice(0, 4).map((item) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-full text-[18px] font-medium transition-all duration-200 ${
                      item.active
